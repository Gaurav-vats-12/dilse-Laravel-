  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
      <img src="{{ setting('logo') != null ? url('/storage/site/logo/'.setting('logo').'') : asset('frontend/img/white-logo.svg')  }}" alt="Dil Se" class="brand-image" style="opacity: .8">
    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
          <a href="{{ route('admin.manage-attributes.index') }}" class="nav-link {{ (request()->is('admin/manage-attributes*')) ? 'active' : '' }}">
              <p>
