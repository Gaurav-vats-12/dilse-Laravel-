<div class="card card-primary">
    ...
    <form method="post" action="{{ route('admin.password.update') }}" class="mt-6 space-y-6">  @csrf  @method('put')
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" id="btnToggle" class="toggle_button" passwordType="current_password"><i id="eyeIcon" passwordType="password" class="fa fa-eye " style="font-size: 16px;"></i></button>
                        ...
                        <x-input-label for="password" :value="__('New Password')" />
                            <x-text-input id="password" name="password" type="password" class="form-control" autocomplete="new-password" />
                             <button type="button" id="btnToggle" class="toggle_button" passwordType="password"><i id="eyeIcon"  class="fa fa-eye " style="font-size: 16px;"></i></button>
