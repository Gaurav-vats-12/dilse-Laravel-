                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{ route('admin.manage-pages.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">@csrf
                        <div class="form-group">
                            ...
                            <input type="hidden" name="pagesuuid" id="pagesuuid" value="{{ \Str::random(10)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="page_slug" readonly id="page_slug" value="{{ old('page_slug')}}">
                            @error('page_slug')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="page_meta_title"  id="page_meta_title" value="{{ old('page_meta_title')}}">
                            @error('page_slug')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <textarea name="page_meta_description" id="page_meta_description" class="form-control">{{ old('page_meta_description')}}</textarea>
