            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card">
                    <div class="card-body">
                    <form method="POST" action="{{ route('admin.testimonial.update' ,$Testimonial->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">@csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="custumber_name">Customer Full Name</label>
                            <input type="text" name="custumber_name" id="custumber_name"  class="form-control" value="{{ old('custumber_name' ,$Testimonial->custumber_name)}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="testonomailsImage" id="testonomailsImage" class="dropify" data-max-height="80" data-max-width="80" data-errors-position= 'outside' data-allowed-file-extensions="png jpg jpng" data-default-file="{{ url('/storage/testimonial/'.$Testimonial->testonomailsImage.'')}}">
