            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card">
                    <div class="card-body">
                    <form method="POST" action="{{ route('admin.manage-gallery.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">@csrf
                        <div class="form-group">
                        <label for="image_title">   {{ __('Title *') }}</label>
                            <input type="text" name="image_title" id="image_title" class="form-control" placeholder ="Image title" value="{{ old('image_title') }}">
                            @error('image_title')
                        ...
                        <label for="gallery_image">   {{ __('Image') }}</label>
                            <input type="file" name="gallery_image" id="gallery_image" class="form-control dropify" >
                            @error('gallery_image')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
