            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.manage-coupon.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"inputmode="numeric" class="short form-control" name="coupon_amount"
                                                    id="coupon_amount" value="{{ old('coupon_amount') }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="maximum_amount"
                                                id="maximum_amount" value="{{ old('maximum_amount', 0.0) }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="coupon_type" id="coupon_type"
                                                ...
                                                <option value="referral"
                                                    {{ old('coupon_type') == 'referral' ? 'selected' : '' }}>Referral
                                                </option>
                                                <option value="offer"
                                                    {{ old('coupon_type') == 'popup' ? 'selected' : '' }}> Offer
                                                </option>
                                            </select>
                                            @error('coupon_type')
                                                <span class="text-danger">{{ $message }}</span>
