                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{ route('admin.blog.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">@csrf
                        ...
                        <label for="blog_slug">   {{ __('Blog Slug *') }}</label>
                            <input type="text" name="blog_slug" id="blog_slug" class="form-control" readonly placeholder ="Blog Slug" value="{{ old('blog_slug') }}">
                            @error('blog_slug')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <textarea name="blog_content" id="blog_content" class="form-control" placeholder="Blog Content" >{{ old('blog_content') }}</textarea>
                            @error('blog_content')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
