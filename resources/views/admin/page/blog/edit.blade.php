            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{ route('admin.blog.update' ,$blog->id )}}" accept-charset="UTF-8" enctype="multipart/form-data">@csrf @method('PUT')
                        ...
                        <textarea name="blog_short_content" id="blog_short_content" class="form-control" placeholder="Blog Short Description" >{{ old('blog_short_content',$blog->blog_short_content) }}</textarea>
