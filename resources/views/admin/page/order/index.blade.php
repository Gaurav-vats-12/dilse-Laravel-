                                ...
                                <tbody>
                                    ...
                                    @foreach ($orders as $key=>  $order)
                                        <tr order_uid ="{{ $order->id }}">
                                            ...
                                            <td class=""><div class="d-flex align-items-center"> <div class="d-flex flex-column">  {{ $order->full_name }} - ( {{ $order->user_type }})<span class="mb-1 text-decoration-none fs-6">{{ $order->email_address }}</span></div> </div></td>
