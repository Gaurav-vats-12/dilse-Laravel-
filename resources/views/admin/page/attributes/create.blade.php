                ...
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{ route('admin.manage-attributes.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">@csrf
                        ...
                        <label for="attributes_name">   {{ __('Name') }}<span class="required"></span></label>
                            <input type="text" name="attributes_name" id="attributes_name" class="form-control" placeholder ="Name" value="{{ old('attributes_name') }}">
                        ...
                        <label for="type">Type</label>
                            <select name="attributes_type" id="type" class="form-control form-select">
                                ...
                                <option value="unit" {{ old('attributes_type') == 'unit' ? 'selected' : '' }}>Unit</option>
                                <option value="other" {{ old('attributes_type') == 'other' ? 'selected' : '' }}>Other</option>
                        </select>
