            ...
            <div class="row">
                ...
                <a href="{{ route('admin.banner.create')}}" type ="button" class="btn btn-success float-right" >Add Banner</a>
                        ...
                        <div class="card-body">
                          ...
                          <a class="btn btn-info btn-sm" href="{{ route('admin.banner.edit', $value->id) }}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <a class="btn btn-danger btn-sm" href="{{ route('admin.banner.destroy', $value->id) }}" data-confirm-delete="true">
