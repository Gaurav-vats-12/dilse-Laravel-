...
<div class="container">
    ...
    <p><strong>Spice Level:</strong>{{ __(  $orderMail['CartDetails']->spice_lavel ?  $orderMail['CartDetails']->spice_lavel : 'Not Found') }} </p>
    ...
    <p>Sincerely,<br>  Dil Se Indian Restaurant </p>
</div>
</body>
</html>
