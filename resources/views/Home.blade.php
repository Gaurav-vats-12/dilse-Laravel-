    ...
    <div class="custm_nav_pills">
      <div class="d-flex align-items-center">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <button class="nav-link" id="v-pills-Non-Veg-tab" data-bs-toggle="pill" data-bs-target="#v-pills-Non-Veg" type="button" role="tab" aria-controls="v-pills-Non-Veg" aria-selected="false">
            Non-Veg <img src="{{asset('frontend/img/arrow_taste.png')}}" alt="" />
          </button>
          <button class="nav-link" id="v-pills-Vegetarian-tab" data-bs-toggle="pill" data-bs-target="#v-pills-Vegetarian" type="button" role="tab" aria-controls="v-pills-Vegetarian" aria-selected="false">
        ...
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade" id="v-pills-Non-Veg" role="tabpanel" aria-labelledby="v-pills-Non-Veg-tab">
            <div class="taste_the_img">
              <img src="{{asset('frontend/img/Non-Veg.png')}}" alt="" />
            </div>
          </div>
          <div class="tab-pane fade" id="v-pills-Vegetarian" role="tabpanel" aria-labelledby="v-pills-Vegetarian-tab">
            <div class="taste_the_img">
        ...
        <div class="best_food_crd">
          ...
          <div class="best_food_cntnt home_best_food_cntnt">
            ...
            <div class="best_food_btn">
              ...
              <a href="javascript:void(0)" class="theme_btn btn-block text-center add-to-cart-button" id="add_to_cart" cart_type="cart" role="button" cart_ajax_url ="{{ route('cart.add') }}"  product_uid ="{{ $FoodItemValue->id }}"> <span class="add-to-cart">Add to cart</span>
