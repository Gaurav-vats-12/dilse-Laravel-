...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="cusstom_input">
            <label for="billing_email" class="">Email address&nbsp;<span class="required"
                                                                         title="required">*</span></label>
            <input type="email" placeholder="Enter Email Address" name="billing_email"
    ...
    <div class="col-md-6">
        <div class="cusstom_input">
            <label for="billing_address_1" class="">Address 1&nbsp;<span class="required"
                                                                         title="required">*</span></label>
            <input type="text" placeholder="House number and street name" name="billing_address_1"
    ...
    <div class="col-md-6">
        <div class="cusstom_input">
            <label for="billing_address_2" class="">Address 2 &nbsp;<span class="required"
                                                                          title="required">*</span></label>
            <input type="text" placeholder="Apartment, suite, unit, etc. (optional)" name="billing_address_2"
    ...
    <div class="col-md-6">
        <div class="cusstom_input">
            ...
            <label for="billing_country" class="">Country &nbsp;<span class="required"
                                                                      title="required">*</span></label>
    ...
    <div class="col-md-6">
        <div class="cusstom_input">
            ...
            <label for="billing_state" class="">Province&nbsp;<span class="required"
                                                                    title="required">*</span></label>
    ...
    <div class="col-md-6">
        <div class="cusstom_input">
            <label for="billing_postcode" class="">Postal code&nbsp;<span class="required"
                                                                          title="required">*</span></label>
            <input type="text" placeholder="" name="billing_postcode" maxlength="7"
