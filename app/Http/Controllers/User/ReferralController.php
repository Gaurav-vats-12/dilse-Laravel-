...
class ReferralController extends Controller
{
   public function index(){
    ...
    $Coupon = Coupon::with(['couponHistories'])->where('user_id', $user_id)->where('status', 1)->first();
    $reffreal_couypon_list = Coupon::with(['couponHistories'])->where('vendor_id', $user_id)->where('status', 1)->get();
