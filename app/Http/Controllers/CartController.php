    ...
    public function addtocart(Request $request ){
        ...
        try {
            if (!empty($request->product_uid)) {
                ...
                $html1 =  view('ajax.cart.add_to_cart')->render();
                $html2 =  view('ajax.cart.add_spice_lavel')->render();
                return response()->json(['code' => 200 , 'status' =>'success','html'=>$html1 ,'html2'=>$html2,'cart_total'=> count((array) session('cart')),"message"=>"Product added to cart successfully."]);
            }else{
